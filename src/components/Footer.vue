...
<template>
  <div
    v-if="isNotHomePage"
    class="bg-[#F0F0F0] border-t border-[#919191] grid grid-cols-2 gap-4 px-2 pt-4 pb-8"
  >
    <a
    ...
    <a
      ...
      target="_blank"
      class="flex flex-col items-center gap-1 ml-8"
    >
      <GoogleIcon />
  ...
  <div
    class="bg-[#F0F0F0] px-2 xs:px-3 sm:px-5 lg:px-10 2xl:px-[224px] py-4 border-t border-[#C4C4C4]"
  >
